...
export function parseOptionalWorkspaceId(value: unknown, label = "workspaceId"): string | undefined {
  if (value == null) return undefined;
  if (typeof value !== "string") {
    throw new HttpError(400, `Field '${label}' must be a string when provided.`);
  }
