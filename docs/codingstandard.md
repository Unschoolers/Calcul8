...
- Before merging, mirror CI locally for the areas you touched: web changes should pass `npm run verify`, API changes should pass `npm run verify:api`, realtime changes should pass `npm run verify:realtime`, and shared tooling/workflow changes should pass `npm run verify:all`.
