...
calcul8.api.functionEntryPoints -> calcul8.web.apiClient "Returns API responses, mapped import rows, entitlement state, and sync results." "HTTPS JSON"
...
calcul8.api.realtimePublisher -> calcul8.realtime.gateway "Posts internal publish events." "HTTPS JSON"
