...
test("spectator page has a bracket-specific render branch and compact tree hooks", () => {
  ...
  const renderSource = readFileSync("src/spectator/render/bracketSpectatorRender.ts", "utf8");
  ...
  assert.match(renderSource, /value == null/);
