...
export const gameWindowDefinition = {
  ...
  computed: {
    ...gameComputeds,
    wheelIsCompactLayout(this: GameWindowThis): boolean {
    ...
    wheelCompactStageSummaryColor(this: GameWindowThis): string {
      return this.wheelMode === "live"
  ...
  watch: {
    ...
    wheelViewportWidth(this: GameWindowThis) {
    ...
    wheelPresentationMode(this: GameWindowThis, presMode: boolean) {
      if (presMode) {
  ...
  methods: {
    ...
    normalizeWheelCompactInspectorState(this: GameWindowThis): void {
    ...
    handleWheelModeChange(this: GameWindowThis, nextMode: "config" | "live"): void {
    ...
    isWheelMobileViewport(this: GameWindowThis): boolean {
      return isWheelCompactViewport((this.wheelViewportWidth as number) || getCurrentViewportWidth());
    },
    openWheelInspector(this: GameWindowThis, tab: "config" | "session" | "history"): void {
    ...
    closeWheelInspector(this: GameWindowThis): void {
      this.wheelMobileInspectorOpen = false;
    ...
    ensureWheelEditorState(this: GameWindowThis): void {
    ...
    refreshWheelCanvas(this: GameWindowThis): void {
    ...
    runWheelPrimarySpin(this: GameWindowThis): void {
      if (this.wheelIsMysteryGrid) {
    ...
    toggleWheelAutospin(this: GameWindowThis): void {
    ...
    toggleWheelSound(this: GameWindowThis): void {
      this.wheelSoundEnabled = !this.wheelSoundEnabled;
    },
    toggleWheelReducedMotion(this: GameWindowThis): void {
      this.wheelReducedMotion = !this.wheelReducedMotion;
    },
    startWheelAutospin(this: GameWindowThis): void {
    ...
    stopWheelAutospin(this: GameWindowThis): void {
    ...
    triggerWheelCelebration(this: GameWindowThis, payload: { label: string; color: string; image?: string; emoji?: string; preview?: boolean }): void {
